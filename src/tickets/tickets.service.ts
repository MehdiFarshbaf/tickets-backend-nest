...
export class TicketsService {
    ...
    async addMessage(ticketId: number, userId: number, dto: CreateMessageDto, userRole: Role) {
    ...
    async updateStatus(ticketId: number, dto: UpdateTicketStatusDto, userRole: Role) {
